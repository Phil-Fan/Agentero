...
export function LayoutPane({
	...
	return (
		<div className="space-y-6">
			...
			<SettingsGroup>
				<SettingsRow
					label={t("layout.backend.label")}
					htmlFor="layout-backend"
					description={t("layout.backend.description")}
				>
					<Select
				...
				<div>
					...
					<div className="rounded-lg border bg-card px-3 py-2.5">
						...
						<div className="mt-2 space-y-1.5">
							...
							<div className="flex items-center gap-2">
								<span className="w-20 shrink-0 font-normal text-muted-foreground text-xs">
									{t("layout.providerConfig.endpoint.label")}
								</span>
